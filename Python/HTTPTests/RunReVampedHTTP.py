...
def g(i):
    for i in range(0,i):
        if i >= 1:
            ...
            main(i-1,"https://instagram.com","https://www.tiktok.com","https://twitter.com","https://www.facebook.com","https://www.origin.com/workers/precache.06c8362d810c64f1.js","https://snapchat.com",13)
