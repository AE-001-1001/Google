...
class App:
    ...
    def new_window(name):
        ...
        for i in range(len(buttons)):
            ...
            b = (buttons[i].config(font=("Sans", 9), background="black", foreground="white", activebackground="black", activeforeground="white"))
            print("Initialized: {}".format(buttons[i]))
            root.after(75, b)
        for zyx in buttons:
        ...
        for ZYX in range(len(another_buttons)):
            ...
            print("Initialized: {}".format(another_buttons[ZYX]))
